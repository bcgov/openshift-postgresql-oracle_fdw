...
RUN yum install -y centos-release-scl-rh && \
    INSTALL_PKGS="rsync tar gettext bind-utils rh-postgresql95 rh-postgresql95-postgresql-contrib nss_wrapper rh-postgresql94-postgresql-server rh-postgresql95-postgresql-devel" && \
