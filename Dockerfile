...
RUN yum install -y centos-release-scl-rh && \
    INSTALL_PKGS="rsync tar gettext bind-utils rh-postgresql10 rh-postgresql10-postgresql-contrib nss_wrapper rh-postgresql10-postgresql-server rh-postgresql10-postgresql-devel" && \
...
ENV PGCONFIG /opt/rh/rh-postgresql10/root/usr/bin
